    ...
    return (
      <>
        <SidebarContent {...rest}>
          ...
          {viewport}
          {(i18n || iconLinks.length > 0 || themeSwitch?.enabled !== false || paletteSwitch?.enabled !== false || footer) && (
              ...
              <div className="flex text-fd-muted-foreground items-center gap-1 empty:hidden">
                ...
                <div className="ms-auto flex items-center gap-1">
                  {paletteSwitch.enabled !== false &&
                    (paletteSwitch.component ?? (
                      <PaletteToggle className="p-0" mode={paletteSwitch.mode} />
                    ))}
        ...
        <SidebarDrawer>
          <div className="flex flex-col gap-3 p-4 pb-2">
            <div className="flex text-fd-muted-foreground items-center gap-1.5">
              ...
              {paletteSwitch.enabled !== false &&
                (paletteSwitch.component ?? <PaletteToggle className="p-0" mode={paletteSwitch.mode} />)}
              {themeSwitch.enabled !== false &&
